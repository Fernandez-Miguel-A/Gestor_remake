...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.cod_Clie_cmb = QComboBox(Dialog)
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.addItem("")
        self.cod_Clie_cmb.setObjectName(u"cod_Clie_cmb")
        self.cod_Clie_cmb.setGeometry(QRect(61, 50, 69, 22))
        self.cod_Clie_cmb.setEditable(False)
        ...
        self.trab_listW.setGeometry(QRect(30, 10, 256, 155))
        ...
        QWidget.setTabOrder(self.name_txt, self.cod_Clie_cmb)
        QWidget.setTabOrder(self.cod_Clie_cmb, self.reg_date)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cod_Clie_cmb.setItemText(0, QCoreApplication.translate("Dialog", u"0", None))
        self.cod_Clie_cmb.setItemText(1, QCoreApplication.translate("Dialog", u"1", None))
        self.cod_Clie_cmb.setItemText(2, QCoreApplication.translate("Dialog", u"2", None))
        self.cod_Clie_cmb.setItemText(3, QCoreApplication.translate("Dialog", u"3", None))
        self.cod_Clie_cmb.setItemText(4, QCoreApplication.translate("Dialog", u"4", None))
        self.cod_Clie_cmb.setItemText(5, QCoreApplication.translate("Dialog", u"5", None))
